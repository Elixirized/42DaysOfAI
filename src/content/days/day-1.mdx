...
---
# Day 1: Dev Environment Setup: First Business Application 
This is the first day of our 42 Days of AI course, where we will set up our development environment for building business web applications using Python. We will install Visual Studio Code (VSCode), configure essential extensions, and set up a virtual environment. We will also explore the Jupyter notebook interface within VSCode and create a simple web application using Flask and Streamlit.

## Table of Contents {/* Should this go below #Install VSCode Extensions? */}
...
6. [First Web App](#first-web-app) {/* This would be moved to day2.mdx*/}
...
pip freeze > requirements.txt
```
### Additional Business Tools {/* Should this sectiongo to another day in the future?*/}
```bash
# Install additional business-focused packages
pip install openpyxl xlsxwriter  # Excel file handling
pip install pillow              # Image processing
...
### Step 5: Launch Jupyter {/* This needs to reflect the usage of Jupyter embedded in VSCode */}
```bash
# Start Jupyter Lab
jupyter lab
...
### Create a Test Jupyter Notebook {/* This section needs to reflect the usage of Jupyter embedded in VSCode  Also, do we even need this section here? Or would it better serve us on another day? */}
1. **Start Jupyter Lab:**
```bash
jupyter lab
```
...
## First Web App {/* Should we put this Streamlit Dashboard app into day2.mdx as the project of the day?*/}
...
## Troubleshooting Common Issues {/* Do we need this section?*/}
...
taskkill /PID <PID> /F
```
{/* Change this to reflect the First Business App being moved to day-2.mdx */}
## Day 1 Recap
